...
import { c as shift, i as flip, n as autoUpdate, r as computePosition, s as offset, t as arrow } from "./floating-ui.dom-BSBJpgLh.js";
...
function g({ type: e = "base", id: t = w } = {}) {
	...
	"style" === (null == o ? void 0 : o.tagName) ? o?.remove() : console.warn(`[react-tooltip] Failed to remove 'style' element with id '${t}'. Call \`injectStyle()\` first`), b[e] = !1;
}
var E = async ({ elementReference: e = null, tooltipReference: t = null, tooltipArrowReference: o = null, place: r = "top", offset: l = 10, strategy: n = "absolute", middlewares: i = [
	offset(Number(l)),
...
}, C = "undefined" != typeof window ? import_react.useLayoutEffect : import_react.useEffect, R = (e) => {
	...
	detach: () => {},
	setActiveAnchor: () => {}
}, $ = (0, import_react.createContext)({ getTooltipData: () => N }), j = ({ children: t }) => {
	const [o, r] = (0, import_react.useState)({ [x]: /* @__PURE__ */ new Set() }), [c, s] = (0, import_react.useState)({ [x]: { current: null } }), a = (e, ...t) => {
		r(((o) => {
			var r;
			const l = null !== (r = o[e]) && void 0 !== r ? r : /* @__PURE__ */ new Set();
		...
		r(((o) => {
			const r = o[e];
			return r ? (t.forEach(((e) => r.delete(e))), { ...o }) : o;
		}));
	}, d = (0, import_react.useCallback)(((e = x) => {
		var t, r;
		return {
			anchorRefs: null !== (t = o[e]) && void 0 !== t ? t : /* @__PURE__ */ new Set(),
			activeAnchor: null !== (r = c[e]) && void 0 !== r ? r : { current: null },
			attach: (...t) => a(e, ...t),
			detach: (...t) => u(e, ...t),
	...
	return import_react.createElement($.Provider, { value: p }, t);
};
function I(e = x) {
	return (0, import_react.useContext)($).getTooltipData(e);
}
var z = ({ tooltipId: t, children: r, className: l, place: n, content: i, html: c, variant: a, offset: u, wrapper: d, events: p, positionStrategy: v, delayShow: m, delayHide: f }) => {
	const { attach: h, detach: w } = I(t), b = (0, import_react.useRef)(null);
	return (0, import_react.useEffect)((() => (h(b), () => {
		w(b);
	})), []), import_react.createElement("span", {
		ref: b,
		className: (0, import_classnames.default)("react-tooltip-wrapper", l),
...
var q = ({ forwardRef: t, id: r, className: i, classNameArrow: c, variant: u = "dark", anchorId: d, anchorSelect: p, place: v = "top", offset: m = 10, events: h = ["hover"], openOnClick: w = !1, positionStrategy: b = "absolute", middlewares: S, wrapper: g, delayShow: A = 0, delayHide: O = 0, float: T = !1, hidden: x = !1, noArrow: N = !1, clickable: $ = !1, closeOnEsc: j = !1, closeOnScroll: z = !1, closeOnResize: q = !1, openEvents: H, closeEvents: M, globalCloseEvents: W, imperativeModeOnly: P, style: V, position: F, afterShow: K, afterHide: U, disableTooltip: X, content: Y, contentWrapperRef: G, isOpen: Z, defaultIsOpen: J = !1, setIsOpen: Q, previousActiveAnchor: ee, activeAnchor: te, setActiveAnchor: oe, border: re, opacity: le, arrowColor: ne, arrowSize: ie = 8, role: ce = "tooltip" }) => {
	...
	const ae = (0, import_react.useRef)(null), ue = (0, import_react.useRef)(null), de = (0, import_react.useRef)(null), pe = (0, import_react.useRef)(null), ve = (0, import_react.useRef)(null), [me, fe] = (0, import_react.useState)({
		...
		tooltipArrowStyles: {},
		place: v
	}), [ye, he] = (0, import_react.useState)(!1), [we, be] = (0, import_react.useState)(!1), [Se, ge] = (0, import_react.useState)(null), Ee = (0, import_react.useRef)(!1), Ae = (0, import_react.useRef)(null), { anchorRefs: _e, setActiveAnchor: Oe } = I(r), ke = (0, import_react.useRef)(!1), [Te, Le] = (0, import_react.useState)([]), Ce = (0, import_react.useRef)(!1), Re = w || h.includes("click"), xe = Re || (null == H ? void 0 : H.click) || (null == H ? void 0 : H.dblclick) || (null == H ? void 0 : H.mousedown), Ne = H ? { ...H } : {
		mouseover: !0,
		focus: !0,
		mouseenter: !1,
		click: !1,
	...
	(0, import_react.useEffect)((() => {
		if (r) {
			if (ye) {
				t(ee);
				const o = e(te), l = [...new Set([...o, r])].filter(Boolean).join(" ");
				te?.setAttribute("aria-describedby", l);
			} else t(te);
			return () => {
				t(te), t(ee);
			};
	...
	const ze = (e) => {
		...
		if (!(null == o ? void 0 : o.isConnected)) return oe(null), void Oe({ current: null });
		A ? Be() : Ie(!0), oe(o), Oe({ current: o }), R(pe);
	}, He = () => {
		...
		[document.querySelector(`[id='${d}']`), ...Te].some(((e) => null == e ? void 0 : e.contains(o))) || (Ie(!1), R(de));
		...
		o ? Me(o) : T ? Ae.current && Me(Ae.current) : null != te && te.isConnected && E({
	...
	(0, import_react.useEffect)((() => {
		...
		const o = new Set(_e);
		Te.forEach(((e) => {
			null != X && X(e) || o.add({ current: e });
		}));
		const r = document.querySelector(`[id='${d}']`);
		r && !(null == X ? void 0 : X(r)) && o.add({ current: r });
		const l = () => {
			Ie(!1);
		}, n = L(te), i = L(ae.current);
		je.scroll && (window.addEventListener("scroll", l), n?.addEventListener("scroll", l), i?.addEventListener("scroll", l));
		let c = null;
		je.resize ? window.addEventListener("resize", l) : te && ae.current && (c = autoUpdate(te, ae.current, Xe, {
			ancestorResize: !0,
			elementResize: !0,
			layoutShift: !0
		}));
		...
		return b && (null === (e = ae.current) || void 0 === e || e.addEventListener("mouseover", h), null === (t = ae.current) || void 0 === t || t.addEventListener("mouseout", w)), a.forEach((({ event: e, listener: t }) => {
			...
			var e, t;
			je.scroll && (window.removeEventListener("scroll", l), n?.removeEventListener("scroll", l), i?.removeEventListener("scroll", l)), je.resize ? window.removeEventListener("resize", l) : c?.(), je.clickOutsideAnchor && window.removeEventListener("click", Pe), je.escape && window.removeEventListener("keydown", s), b && (null === (e = ae.current) || void 0 === e || e.removeEventListener("mouseover", h), null === (t = ae.current) || void 0 === t || t.removeEventListener("mouseout", w)), a.forEach((({ event: e, listener: t }) => {
				o.forEach(((o) => {
					var r;
		...
		const l = new MutationObserver(((e) => {
			const t = [], l = [];
			e.forEach(((e) => {
				if ("attributes" === e.type && "data-tooltip-id" === e.attributeName) e.target.getAttribute("data-tooltip-id") === r ? t.push(e.target) : e.oldValue === r && l.push(e.target);
				if ("childList" === e.type) {
					if (te) {
			...
			})), (t.length || l.length) && Le(((e) => [...e.filter(((e) => !l.includes(e))), ...t]));
		}));
		...
		var e;
		const t = document.querySelector(`[id='${d}']`), o = [...Te, t];
		...
		if (!t && r && (t = `[data-tooltip-id='${r.replace(/'/g, "\\'")}']`), t) try {
			Le(Array.from(document.querySelectorAll(t)));
		} catch (e) {
			Le([]);
		}
	}), [
	...
	return (0, import_react.useImperativeHandle)(t, (() => ({
		open: (e) => {
			if (null == e ? void 0 : e.anchorSelect) try {
				document.querySelector(e.anchorSelect);
			} catch (t) {
				console.warn(`[react-tooltip] "${e.anchorSelect}" is not a valid CSS selector`);
				return;
			}
	...
	}))), we && !x && Ye ? import_react.createElement(g, {
		id: r,
		role: ce,
		className: (0, import_classnames.default)("react-tooltip", B.tooltip, D.tooltip, D[u], i, `react-tooltip__place-${me.place}`, B[Ge ? "show" : "closing"], Ge ? "react-tooltip__show" : "react-tooltip__closing", "fixed" === b && B.fixed, $ && B.clickable),
		onTransitionEnd: (e) => {
			R(ve), ye || "opacity" !== e.propertyName || (be(!1), ge(null), U?.());
		},
		style: {
			...V,
			...me.tooltipStyles,
		...
		ref: ae
	}, Ye, import_react.createElement(g, {
		className: (0, import_classnames.default)("react-tooltip-arrow", B.arrow, D.arrow, c, N && B.noArrow),
		style: {
...
}, H = ({ content: t }) => import_react.createElement("span", { dangerouslySetInnerHTML: { __html: t } }), M = import_react.forwardRef((({ id: t, anchorId: r, anchorSelect: n, content: i, html: c, render: a, className: u, classNameArrow: d, variant: p = "dark", place: v = "top", offset: m = 10, wrapper: f = "div", children: h = null, events: w = ["hover"], openOnClick: b = !1, positionStrategy: S = "absolute", middlewares: g, delayShow: E = 0, delayHide: _ = 0, float: O = !1, hidden: k = !1, noArrow: T = !1, clickable: L = !1, closeOnEsc: C = !1, closeOnScroll: R = !1, closeOnResize: x = !1, openEvents: N, closeEvents: $, globalCloseEvents: j, imperativeModeOnly: z = !1, style: B, position: D, isOpen: M, defaultIsOpen: W = !1, disableStyleInjection: P = !1, border: V, opacity: F, arrowColor: K, arrowSize: U, setIsOpen: X, afterShow: Y, afterHide: G, disableTooltip: Z, role: J = "tooltip" }, Q) => {
	const [ee, te] = (0, import_react.useState)(i), [oe, re] = (0, import_react.useState)(c), [le, ne] = (0, import_react.useState)(v), [ie, ce] = (0, import_react.useState)(p), [se, ae] = (0, import_react.useState)(m), [ue, de] = (0, import_react.useState)(E), [pe, ve] = (0, import_react.useState)(_), [me, fe] = (0, import_react.useState)(O), [ye, he] = (0, import_react.useState)(k), [we, be] = (0, import_react.useState)(f), [Se, ge] = (0, import_react.useState)(w), [Ee, Ae] = (0, import_react.useState)(S), [_e, Oe] = (0, import_react.useState)(null), [ke, Te] = (0, import_react.useState)(null), Le = (0, import_react.useRef)(null), Ce = (0, import_react.useRef)(P), { anchorRefs: Re, activeAnchor: xe } = I(t), Ne = (e) => null == e ? void 0 : e.getAttributeNames().reduce(((t, o) => {
		var r;
	...
	(0, import_react.useEffect)((() => {
		...
		if (i && o.add({ current: i }), !o.size) return () => null;
		...
		null != B && B.border && console.warn("[react-tooltip] Do not set `style.border`. Use `border` prop instead."), V && !A("border", `${V}`) && console.warn(`[react-tooltip] "${V}" is not a valid \`border\`.`), null != B && B.opacity && console.warn("[react-tooltip] Do not set `style.opacity`. Use `opacity` prop instead."), F && !A("opacity", `${F}`) && console.warn(`[react-tooltip] "${F}" is not a valid \`opacity\`.`);
	}), []);
	let je = h;
	...
	if (a) {
		...
		je = t ? import_react.createElement("div", {
			ref: Ie,
	...
	const ze = {
		...
		setActiveAnchor: (e) => {
			Te(((t) => (null != e && e.isSameNode(t) || (Le.current = t), e)));
		},
		role: J
	};
